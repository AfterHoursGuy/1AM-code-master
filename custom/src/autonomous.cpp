...
void skills() { 
  ...
  turnToAngle(45, 800);
  descore.set(false);
  moveToPoint(14.5, -19.5, 1, 1500, true, 8);
  descore.set(true);
  turnToAngle(-45, 800);
  descore.set(false);
  driveTo(19.5, 1000, true, 10);
  scraper.set(true);
  intake_lift.set(false);
  ...
  scraper.set(false);
  wait(150, msec);
  lower_intake.spin(reverse, 8, voltageUnits::volt);
  ...
  upper_intake.spin(fwd, 12, voltageUnits::volt);
  intake_lift.set(true);
  boomerang(-40, -48, 1, 180, 0.1, 2000, true, 10.5);
  turnToAngle(180, 200);
  scraper.set(true);
  wait(100, msec);
  resetPositionFront(frontsensor, 2.875, 7.5, 72);
  ...
  boomerang(-63, -26, -1, 180, 0.3, 1000, true, 11);
  turnToAngle(180, 200);
  scraper.set(false);
  upper_intake.stop();
  lower_intake.stop();
  moveToPoint(-60, 41, -1, 2000, true, 10);
  wait(100, msec);
  turnToAngle(-90, 500);
  ...
  resetPositionFront(frontsensor, 2.875, 7.5, 72);
  resetPositionLeft(leftSide, 3.375, 1, 72);
  boomerang(-22, 66, 1, 90, 0.3, 2000, true, 11);
  turnToAngle(90, 300);
  correct_angle = 90;
  driveTo(7, 800, true, 12);
  turnToAngle(90, 500);
  descore.set(true);
  wings.set(true);
  ...
  driveChassis(0, 0);
  wait(200, msec);
  driveToWallRight(44, 800, 0, true, 12);
  turnToAngle(180, 800);
  descore.set(false);
  scraper.set(false);
  correct_angle = 180;
  ...
  resetPositionLeft(leftSide, 3.375, 1, 72);
  wait(20, msec);
  driveFromWall(50.5, 1300, 0, true, 8);
  descore.set(true);
  ...
  wait(700, msec);
  upper_intake.spin(fwd, 20, pct);
  wait(1900, msec);
  upper_intake.stop();
  driveTo(-1.5, 600, true, 5);
  thread([]{
    wait(200, msec);
    upper_intake.spin(fwd, 12, voltageUnits::volt);
  });
  boomerang(37, 51, 1, 0, 0.1, 2000, true, 11);
  mid_goal.set(false);
  scraper.set(true);
  turnToAngle(0, 800);
  wait(50, msec);
  ...
  resetPositionRight(rightSide, 3.375, 1, 72);
  wait(50, msec);
  moveToPoint(49.25, 61, 1, 800, false, 12);
  driveToWall(8.2, 800, 900, true, 12);
  wait(50, msec);
  resetPositionFront(frontsensor, 2.875, 7.5, 72);
  resetPositionRight(rightSide, 3.375, 1, 72);
  wait(50, msec);
  ...
  scraper.set(false);
  boomerang(64, -39, -1, 190, 0.1, 2000, true, 11);
  wait(100, msec);
  turnToAngle(90, 800);
  ...
  upper_intake.spin(fwd, 12, voltageUnits::volt);
  wings.set(true);
  driveToWall(8, 800, 1000, true, 12);
  resetPositionFront(frontsensor, 2.875, 7.5, 72);
  resetPositionLeft(leftSide, 3.375, 1, 72);
  thread([]{
    upper_intake.spin(fwd, -12, voltageUnits::volt);
  ...
  moveToPoint(51, -20, -1, 1000, true, 12);
  wings.set(false);
  wait(100, msec);
  upper_intake.spin(fwd, 12, voltageUnits::volt);
  wait(1700, msec);
  ...
  scraper.set(false);
  descore.set(true);
  boomerang(11, -68, 1, -90, 0.3, 2000, false, 12);
  correct_angle = -90;
  driveTo(29, 20000, true, 12);
