...
void sigsoloAWP(){
  ...
  moveToPoint(46, -29, -1, 1300, true, 10);
  gate.set(false);
  ...
  resetPositionLeft(leftSide, 6.375, 0, 70.25);
  driveTo(3, 700, true);
  turnToPoint(-24, -22, 1, 800);
  gate.set(true);
  wait(20, msec);
  lower_intake.spin(fwd, 12, voltageUnits::volt);
  resetPositionLeft(leftSide, 0, 6.375, 70.25);
  resetPositionBack(backSide, 9, 0, 70.25);
  moveToPoint(24, -22, 1, 1000, false, 11);
  thread([]{doinker(800);});
  moveToPoint(-26, -22, 1, 2000, true, 11);
  wait(50, msec);
  ...
  wait(50, msec);
  mid_goal.set(false);
  moveToPoint(-10.5, -11, -1, 1300, true, 10);
  wait(50, msec);
  turnToAngle(225, 600);
  gate.set(false);
  ...
  boomerang(-40, -45, 1, 180, 0.3, 2800, true, 10, true);
  turnToAngle(180, 200);
  scraper.set(true);
  lower_intake.spin(fwd, 12, voltageUnits::volt);
  resetPositionFront(Rwall_distance_sensor, 4.25, 5, 70.25);
  ...
  wait(50, msec);
  boomerang(-46, -60, 1, 180, 0.1, 1300, true, 8);
  driveToWall(6.5, 600, 0, true, 12);
  resetPositionFront(Rwall_distance_sensor, 4.25, 5, 70.25);
  resetPositionRight(rightSide, 6.375, 0, 70.25);
  wait(50, msec);
  moveToPoint(-45.25, -29, -1, 1800, false, 12);
  gate.set(false);
...
void rightsidequal(){
  ...
  resetPositionFront(Rwall_distance_sensor, 4.25, 5, 70.25);
  resetPositionLeft(leftSide, 6.375, 0, 70.25);
  moveToPoint(46.75, -29, -1, 1300, true, 10);
  driveToWall(34, 200, 0, true, 12);
  gate.set(false);
  stick.spin(fwd, 40, percent);
  wait(900, msec);
  lower_intake.spin(fwd, -12, voltageUnits::volt);
  ...
  resetPositionLeft(leftSide, 6.375, 0, 70.25);
  driveTo(3, 700, true);
  turnToPoint(-24, -22, 1, 900);
  gate.set(true);
  wait(20, msec);
  lower_intake.spin(fwd, 12, voltageUnits::volt);
  resetPositionLeft(leftSide, 0, 6.375, 70.25);
  resetPositionBack(backSide, 9, 0, 70.25);
  moveToPoint(23, -22, 1, 1000, false, 11);

  //low goal
  driveTo(16, 1300, true, 9);
  lower_intake.spin(fwd, -12, voltageUnits::volt);
  ...
  wait(50, msec);
  mid_goal.set(false);
  moveToPoint(-10.5, -12, -1, 1300, true, 10);
  wait(50, msec);
  turnToAngle(225, 600);
  gate.set(false);
  stick.spin(fwd, 30, percent);
...
void leftsidequal(){
  ...
  moveToPoint(-18, 37, 1, 1600, false, 12);
  swing(-90, 1, 600, true, 12);
  scraper.set(true);
  swing(-30, -1, 700, false, 12);
  boomerang(-20, 12, -1, 200, 0.2, 2000, true, 12);
  turnToAngle(20, 800, false);
  mid_goal.set(true);
  swing(90, -1, 1000, false, 12);
  swing(180, -1, 600, true, 12);
  driveToWall(35, 800, 0, true, 12);
  gate.set(false);
  ...
  resetPositionRight(rightSide, 6.375, 0, 70.25);
  wait(50, msec);
  boomerang(-46, -60, 1, 180, 0.1, 1300, true, 12);
  driveToWall(6.5, 700, 0, true, 12);
  resetPositionFront(Rwall_distance_sensor, 4.25, 5, 70.25);
  resetPositionRight(rightSide, 6.375, 0, 70.25);
  mid_goal.set(false);
  moveToPoint(-14.5, -15, -1, 1300, true, 12);
  turnToAngle(225, 300);
  gate.set(false);
  stick.spin(fwd, 50, percent);
  wait(500, msec);
  lower_intake.spin(fwd, -12, voltageUnits::volt);
  wait(100, msec);
  thread([]{reset();});
  ...
  boomerang(-37, -38, 1, 180, 0.4, 2800, true, 12);
  turnToAngle(180, 200);
  left_chassis.setStopping(hold);
  right_chassis.setStopping(hold);
  correct_angle = 180;
  driveTo(-24, 50000, true, 12);
...
void skills() { 
  ...
  turnToAngle(225, 500);
  wait(50, msec);
  boomerang(-6.5, -15.5, -1, 45, 0.3, 2000, true, 8);
  lower_intake.spin(fwd, 12, voltageUnits::volt);
  turnToAngle(225, 500);
  gate.set(false);
  ...
  moveToPoint(-57, 44, -1, 1500, true, 11);
  wait(100, msec);
  turnToAngle(90, 800);
  wait(100, msec);
  ...
  resetPositionLeft(leftSide, 6.375, 0, 70.25);
  wait(50, msec);
  driveTo(2, 800, false, 11);
  boomerang(-15, 69, 1, 90, 0.3, 1200, true, 10);
  mid_goal.set(false);
  stick.spin(fwd, 100, percent);
  wait(100, msec);
  turnToAngle(90, 800);
  ...
  driveChassis(7, 7.25);
  wait(1100, msec);
  driveToWallRight(28.5, 800, 0, true, 8);
  ...
  lower_intake.spin(fwd, 12, voltageUnits::volt);
  wait(50, msec);
  boomerang(4.25, 14, -1, 45, 0.2, 1500, true, 9);
  wait(50, msec);
  turnToAngle(45, 800);
  gate.set(false);
  wait(100, msec);
  ...
  scraper.set(true);
  mid_goal.set(true);
  boomerang(37, 48, 1, 45, 0.4, 1500, true, 11);
  turnToAngle(0, 700);
  wait(50, msec);
  resetPositionFront(Rwall_distance_sensor, 4.125, 5, 70.25);
  resetPositionRight(rightSide, 6.375, 0, 70.25);
  ...
  turnToAngle(180, 500);  
  moveToPrevPos();
  driveToWall(34.75, 250, 0, true, 12);
  gate.set(false);
  stick.spin(fwd, 20, percent);
  wait(700, msec);
  stick.spin(fwd, 10, percent);
  ...
  boomerang(5.5, -9, 1, 315, 0.4, 2000, true, 7);
  lower_intake.spin(fwd, -12, voltageUnits::volt);
  wait(1000, msec);
  mid_goal.set(false);
  ...
  boomerang(-24.67420, -65, 1, -90, 0.1, 5000, true, 10);
}
...
void elimleft(){
  ...
  resetPositionFront(Rwall_distance_sensor, 4.25, 5, 70.25);
  resetPositionRight(rightSide, 6.375, 0, 70.25);
  moveToPoint(-47, -29, -1, 1300, true, 10);
  gate.set(false);
  wait(80, msec);
